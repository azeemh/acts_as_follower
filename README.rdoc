...
=== The master branch supports Rails 7.2+
To Install, add this to your gemfile:
  gem 'acts_as_follower', git: 'https://github.com/azeemh/acts_as_follower'
then
  bundle update acts_as_follower --source=https://github.com/azeemh/acts_as_follower

=== The original author's master branch supports Rails 5+
